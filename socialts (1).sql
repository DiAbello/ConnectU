...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 22 2024 г., 05:19
...
(11, '2024_01_21_105504_friendlist', 6),
(12, '2024_01_21_110248_friendlist', 7);
...
INSERT INTO `posts` (`id`, `user_id`, `public_id`, `created_at`, `content`, `like_count`) VALUES
(4, 11, NULL, '2024-01-01 21:48:36', 'дада это я', 0),
(5, 10, NULL, '2024-01-02 00:01:35', 'Самый крутой пост, правда он тестовый :(((', 0),
(7, 12, NULL, '2024-01-02 00:08:09', 'У меня в жизни вообще всё прекрасно, и быть лучше не может', 0),
(8, 11, NULL, '2024-01-03 13:59:50', 'у меня всё гуд', 0),
(24, 11, NULL, '2024-01-19 10:05:10', 'Пост про всякое', 0),
(27, 11, NULL, '2024-01-22 14:17:33', 'awd', 0);
...
(13, 24, 'плита.jpg', 0, '2024-01-19 10:05:10'),
(14, 24, 'фото.png', 0, '2024-01-19 10:05:10'),
(24, 27, 'Andrew_Garfield_as_Spider-Man.jpg', 0, '2024-01-22 14:17:33'),
(25, 27, 'GOruahYKFFLIMumRcRE_nQ.jpeg', 0, '2024-01-22 14:17:33'),
(26, 27, 'khrabroe-serdtse-uil-yam-uolles-oboi-3840x2400_9.jpg', 0, '2024-01-22 14:17:33'),
(27, 27, 'Screenshot_1.png', 0, '2024-01-22 14:17:33');
...
--
-- Дамп данных таблицы `publics`
--

INSERT INTO `publics` (`id`, `name`, `public_tag`, `created_by`, `public_photo`) VALUES
(1, 'test', 'test', 10, 'test');
...
(11, 'Илья', 'test@g.c', NULL, '$2y$12$fRxweYUCMU9pOXNzsqfoDO5RS2muFWNNy2DvOq2yDsJzChPiTYVp.', 'M5Hr1hwwYEEWhdPkZWqiaK0Is7zXshvOBK4WfDXlRjLrONeZP4', NULL, NULL, 'Потапов', '@diabello', 'GOruahYKFFLIMumRcRE_nQ.jpeg'),
...
(11, 'GOruahYKFFLIMumRcRE_nQ.jpeg', 15, '2024-01-19 10:12:47', 0);
...
--
ALTER TABLE `friendlist`
  ADD CONSTRAINT `friendlist_person1_foreign` FOREIGN KEY (`person1`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `friendlist_person2_foreign` FOREIGN KEY (`person2`) REFERENCES `users` (`id`);
